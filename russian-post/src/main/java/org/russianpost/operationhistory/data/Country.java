 ...
 *         &lt;element name="Code2A" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="Code3A" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
public class Country {
    ...
    @XmlElement(name = "Id")
    protected int id;
    @XmlElement(name = "Code2A", required = true)
    protected String code2A;
    @XmlElement(name = "Code3A", required = true)
