 ...
 *       &lt;sequence>
 *         &lt;element name="DestinationAddress" type="{http://russianpost.org/operationhistory/data}Address"/>
 *         &lt;element name="OperationAddress" type="{http://russianpost.org/operationhistory/data}Address"/>
 *         &lt;element name="MailDirect" type="{http://russianpost.org/operationhistory/data}Country"/>
 *         &lt;element name="CountryFrom" type="{http://russianpost.org/operationhistory/data}Country"/>
...
public class AddressParameters {
    ...
    @XmlElement(name = "MailDirect", required = true)
    protected Country mailDirect;
    @XmlElement(name = "CountryFrom", required = true)
